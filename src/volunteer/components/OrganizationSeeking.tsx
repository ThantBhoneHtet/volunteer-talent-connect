...
export const OrganizationSeeking = () => {
    ...
    <section id="organizations" className="py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
              ...
              >
                ...
                <CardContent>
                  ...
                  <div className="flex gap-2">
                    ...
                    className={`flex-1 bg-gradient-to-r ${getTypeColor(org.type)} hover:shadow-lg group text-white transition-all duration-200`}>
                      Learn More
        ...
        <div className="text-center">
          <Button 
          onClick={() => navigate("/volunteer/pages/ViewAllPost")}
            variant="outline" 
            size="lg" 
